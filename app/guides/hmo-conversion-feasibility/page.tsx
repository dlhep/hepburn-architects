...
const guide = guides.find((item) => item.slug === "hmo-conversion-feasibility");

export const metadata: Metadata = guide ? {
  title: guide.metaTitle,
  description: guide.metaDescription,
  alternates: { canonical: `/guides/hmo-conversion-feasibility` },
  openGraph: {
    title: guide.metaTitle,
    description: guide.metaDescription,
    url: `https://www.hepburnarchitects.net/guides/hmo-conversion-feasibility`,
    type: "article"
  }
} : {};
...
export default function Page() {
  if (!guide) notFound();
  const url = `https://www.hepburnarchitects.net/guides/hmo-conversion-feasibility`;
  return (
    <>
      <StructuredData data={{
