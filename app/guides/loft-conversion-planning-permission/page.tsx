...
const guide = guides.find((item) => item.slug === "loft-conversion-planning-permission");

export const metadata: Metadata = guide ? {
  title: guide.metaTitle,
  description: guide.metaDescription,
  alternates: { canonical: `/guides/loft-conversion-planning-permission` },
  openGraph: {
    title: guide.metaTitle,
    description: guide.metaDescription,
    url: `https://www.hepburnarchitects.net/guides/loft-conversion-planning-permission`,
    type: "article"
  }
} : {};
...
export default function Page() {
  if (!guide) notFound();
  const url = `https://www.hepburnarchitects.net/guides/loft-conversion-planning-permission`;
  return (
    <>
      <StructuredData data={{
