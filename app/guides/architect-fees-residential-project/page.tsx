...
const guide = guides.find((item) => item.slug === "architect-fees-residential-project");

export const metadata: Metadata = guide ? {
  title: guide.metaTitle,
  description: guide.metaDescription,
  alternates: { canonical: `/guides/architect-fees-residential-project` },
  openGraph: {
    title: guide.metaTitle,
    description: guide.metaDescription,
    url: `https://www.hepburnarchitects.net/guides/architect-fees-residential-project`,
    type: "article"
  }
} : {};
...
export default function Page() {
  if (!guide) notFound();
  const url = `https://www.hepburnarchitects.net/guides/architect-fees-residential-project`;
  return (
    <>
      <StructuredData data={{
