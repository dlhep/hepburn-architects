...
const guide = guides.find((item) => item.slug === "building-regulations-drawings");

export const metadata: Metadata = guide ? {
  title: guide.metaTitle,
  description: guide.metaDescription,
  alternates: { canonical: `/guides/building-regulations-drawings` },
  openGraph: {
    title: guide.metaTitle,
    description: guide.metaDescription,
    url: `https://www.hepburnarchitects.net/guides/building-regulations-drawings`,
    type: "article"
  }
} : {};
...
export default function Page() {
  if (!guide) notFound();
  const url = `https://www.hepburnarchitects.net/guides/building-regulations-drawings`;
  return (
    <>
      <StructuredData data={{
