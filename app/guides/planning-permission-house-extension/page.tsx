...
const guide = guides.find((item) => item.slug === "planning-permission-house-extension");

export const metadata: Metadata = guide ? {
  title: guide.metaTitle,
  description: guide.metaDescription,
  alternates: { canonical: `/guides/planning-permission-house-extension` },
  openGraph: {
    title: guide.metaTitle,
    description: guide.metaDescription,
    url: `https://www.hepburnarchitects.net/guides/planning-permission-house-extension`,
    type: "article"
  }
} : {};
...
export default function Page() {
  if (!guide) notFound();
  const url = `https://www.hepburnarchitects.net/guides/planning-permission-house-extension`;
  return (
    <>
      <StructuredData data={{
