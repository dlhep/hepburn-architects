...
export default function Page() {
  return (
    <>
      ...
      <section className="section studio-manifesto">
        <div className="shell manifesto-grid">
          ...
          <div>
            ...
            <h2>Four questions to answer before design begins.</h2>
          </div>
          <div className="manifesto-copy">
            <p>
              A successful project starts by resolving feasibility, planning, cost and process—not by rushing into drawings.
            </p>
          </div>
        </div>

        <div className="shell note-grid decision-grid">
        ...
        <div className="shell decision-action">
          <Link href="/estimate" className="btn primary">Start a feasibility check <ArrowRight size={17}/></Link>
        </div>
      </section>
      ...
      <section className="section project-editorial" id="projects">
        <div className="shell project-heading">
          <span>HEPBURN / PROJECTS</span>
          <div><h2>Projects shown as decisions, not decoration.</h2><Link href="/projects" className="text-link">View all projects <ArrowRight size={15}/></Link></div>
        </div>
